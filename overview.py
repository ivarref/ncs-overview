...
if __name__=="__main__":
    ...
    for dec in decades:
        ...
        print("|", dec, "|", " | ".join(v), "|")
    #v.append(get_overview('./oil_production_by_discovery_decade.csv')[1])
    #v.append(get_overview('./gas_production_by_discovery_decade.csv')[1])
    #print(v)
    #generate_overview("Petroleum", './oe_production_by_discovery_decade.csv')
    #generate_overview("Olje", './oil_production_by_discovery_decade.csv')
    #generate_overview("Gass", './gas_production_by_discovery_decade.csv')
